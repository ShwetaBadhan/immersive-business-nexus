...
export const SERVICES: Service[] = [
  {
    id: "business-research-and-growth-strategy",
    index: "01",
    title: "RESEARCH",
    short: "Business Research & Growth Strategy",
   ...
   {
    id: "e-commerce-and-marketplace-growth",
    index: "02",
    title: "E-COMMERCE",
    short: "E-Commerce & Marketplace Growth",
  ...
  {
    id: "warehousing-fulfillment-and-logistics",
    index: "03",
    title: "OPERATIONS",
    short: "Warehousing, Fulfillment & Logistics",
  ...
  {
    id: "branding-creative-and-content",
    index: "04",
    title: "BRAND",
    short: "Branding, Creative & Content",
  ...
  {
    id: "digital-marketing-and-social-growth",
    index: "05",
    title: "MARKETING",
    short: "Digital Marketing & Social Growth",
  ...
  },
  {
    ...
    index: "06",
    title: "TECHNOLOGY",
    short: "Technology & Digital Solutions",
  ...
  {
    id: "pr-sponsorship-and-business-communications",
    index: "07",
    title: "COMMUNICATION",
    short: "PR, Sponsorship & Business Communications",
    body: "Helping businesses modernize processes, platforms and customer experiences.",
    glyph: "9",
    lede: "Modernisation without disruption — process, platform and people moved together, in the right order.",
    capabilities: [
  ...
  {
    id: "business-setup-legal-and-compliance",
    index: "08",
    title: "BUSINESS SUPPORT",
    short: "Business Setup, Legal & Compliance",
    body: "Helping businesses modernize processes, platforms and customer experiences.",
    glyph: "9",
    lede: "Modernisation without disruption — process, platform and people moved together, in the right order.",
    capabilities: [
  ...
  {
    id: "corporate-merchandise-and-promotional-solutions",
    index: "09",
    title: "PROMOTIONAL",
    short: "Corporate Merchandise & Promotional Solutions",
    body: "Helping businesses modernize processes, platforms and customer experiences.",
    glyph: "9",
    lede: "Modernisation without disruption — process, platform and people moved together, in the right order.",
    capabilities: [
