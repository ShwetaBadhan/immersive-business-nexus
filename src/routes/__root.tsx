      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `try{var t=localStorage.getItem("239-theme")||"light";var r=document.documentElement;if(t==="dark")r.classList.add("dark");r.setAttribute("data-theme",t);r.style.colorScheme=t;}catch(e){}`,
          }}
        />
      </head>
      <body>
